...
<div class="container">
  ...
  <h1 style="text-align: center;">Edit Product</h1>
    <form id="editProductForm" action="productsV.php" method="get">
    ...
    <br><br>
    <button type="reset" id="clearProdBtn" form="editProductForm">Clear</button>
    <button type="submit" id="addProdBtn" form="editProductForm">Add Product</button>
    <br><br>
